...
plt.tight_layout()
plt.savefig('Unemployment Analysis/01_unemployment_trend.png', dpi=300, bbox_inches='tight')
...
plt.tight_layout()
plt.savefig('Unemployment Analysis/02_pre_covid_vs_covid.png', dpi=300, bbox_inches='tight')
...
for i, v in enumerate(area_means.values):
    ax.text(i, v + 0.2, f'{v:.2f}%', ha='center', fontweight='bold')
plt.tight_layout()
plt.savefig('Unemployment Analysis/03_urban_vs_rural.png', dpi=300, bbox_inches='tight')
...
plt.tight_layout()
plt.savefig('Unemployment Analysis/04_top_10_affected_regions.png', dpi=300, bbox_inches='tight')
...
plt.tight_layout()
plt.savefig('Unemployment Analysis/05_regional_distribution.png', dpi=300, bbox_inches='tight')
...
plt.tight_layout()
plt.savefig('Unemployment Analysis/06_covid_impact_heatmap.png', dpi=300, bbox_inches='tight')
...
plt.xticks(rotation=45)
plt.tight_layout()
plt.savefig('Unemployment Analysis/07_labour_participation_trend.png', dpi=300, bbox_inches='tight')
...
print("="*60)
print("\nAll visualizations have been saved to the 'Unemployment Analysis' folder.")
print("\nKey Findings:")
